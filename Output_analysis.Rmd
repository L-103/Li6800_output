...
# selected_file <- "C:\\Users\\lcta0001\\OneDrive - Sveriges lantbruksuniversitet\\Skrivbordet\\logs\\2024-03-14-1420_trainingaci"
# selected_file <- "C:\\Users\\lcta0001\\OneDrive - Sveriges lantbruksuniversitet\\Skrivbordet\\2024-02-27"
...
for (file in xlsx_files) {
    ...
    b5_value <- as.numeric(xls_data[4, 2])  # Row 5, Column 2 (B)
...
merge_with_precision <- function(df1, df2, by_column, precision = 5) {
  merged_df <- merge(df1, df2, by = NULL)  # Cartesian product
  
  # Filter rows based on precision
...
# Function to append data from each file to the big dataframe
...
# Iterate over interesting files and append data to big dataframe
...
server <- function(input, output) {
  ...
  # Filter data based on selected file choices
