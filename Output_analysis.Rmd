...
data <- data[-c(1, 2), ]
columns_to_exclude <- c("time", "date", "hhmmss", "averaging", "TIME")
...
#   selected = c("obs", "elapsed", "E", "A", "Ci"),
#   multiple = TRUE  
# )
column_selector <- tagList(
  checkboxInput("select_all_columns", "Show advanced parameters in the list of options", FALSE),
  selectInput(
    inputId = "columns",
    label = "If you want to extract specific columns of your data file:",
...
# Observe the change in the checkbox and update the choices accordingly
